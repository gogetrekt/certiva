...
const verify_credential_dto_1 = require("./dto/verify-credential.dto");
...
let VerificationController = class VerificationController {
    ...
    verify(dto, req) {
        ...
        return this.verificationService.verify(dto, ip);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [verify_credential_dto_1.VerifyCredentialDto, Object]),
